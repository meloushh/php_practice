...
<?php if (isset($_COOKIE['_a'])): ?>
    ...
    <div class="flex border_b1 align_center" style="height: 8vh; min-height: min-content; border-bottom: 2px solid var(--color10);">
        <a href="/documents" class="block p1 pl2 hover_fc1 fs4 yuji"><?= App::$si->name ?></a>
